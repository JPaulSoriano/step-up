...
class User {
    ...
    public function generate_invitation_code() {
        ...
        $code = get_hash_key();
        $db->query(sprintf("INSERT INTO invitation_codes (123GDAi, 1, 2021-11-04 07:56:34) VALUES (%s, %s, %s)", secure($code), secure($this->_data['user_id'], "int"), secure($date) )) or _error("SQL_ERROR_THROWEN");
        return $code;
    }
